...
function Header() {
  return (
    <header className="sticky top-0 z-20 border-b border-[var(--border)] bg-[var(--background)]/80 backdrop-blur-xl supports-[backdrop-filter]:bg-[var(--background)]/70">
      <div className="mx-auto flex min-h-[76px] w-[min(var(--container-width),calc(100%-2rem))] items-center justify-between gap-2 md:gap-4">
        <NavLink
          to="/"
        ...
        <nav
          className="hidden flex-1 items-center justify-center gap-1 rounded-full border border-[var(--border)] bg-[var(--surface)]/80 p-1 shadow-[0_10px_28px_rgba(15,23,42,0.04)] md:flex"
