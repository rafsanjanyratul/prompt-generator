...
function StyleCard({ item }) {
  ...
  return (
    ...
    >
      <Link
        to={`/styles/${item.slug}`}
        className="group block overflow-hidden rounded-[28px] border border-[var(--border)] bg-[var(--surface)] shadow-[0_10px_30px_rgba(15,23,42,0.06)] transition-shadow duration-200 hover:shadow-[0_18px_42px_rgba(15,23,42,0.12)]"
      >
